...
/*
 * LG Function Driver List
 */
#ifdef CONFIG_LGE_USB_GADGET_DRIVER
char *usb_functions_lge_all[] = { // for 0x61FA
	"acm",
	"diag",
	"usb_mass_storage",
	"adb",
...
/* LG Manufacturing mode (Factory Driver) */
...
// We don`t need USB Tethering for E0TRF
#ifdef CONFIG_LGE_USB_GADGET_DRIVER
...
void __init lge_add_usb_devices(void)
{
	...
	platform_add_devices(e0eu_usb_devices,
	ARRAY_SIZE(e0eu_usb_devices));
