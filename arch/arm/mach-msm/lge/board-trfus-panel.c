...
static struct platform_device *e0trf_panel_devices[] __initdata = {
...
static int e0trf_fb_event_notify(struct notifier_block *self,
...
static struct notifier_block e0eu_fb_event_notifier = {
	.notifier_call	= e0trf_fb_event_notify,
};
...
#ifdef CONFIG_BACKLIGHT_RT9396
void __init msm7x27a_e0trf_init_i2c_backlight(int bus_num)
{
...
void __init lge_add_lcd_devices(void)
{
	...
	platform_add_devices(e0trf_panel_devices, ARRAY_SIZE(e0trf_panel_devices));
	msm_fb_add_devices();
	lge_add_gpio_i2c_device(msm7x27a_e0trf_init_i2c_backlight);
}
