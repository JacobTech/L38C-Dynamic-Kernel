...
#elif defined(CONFIG_BACKLIGHT_RT9396)
...
static uint32_t camera_off_gpio_table[] = {
	...
	GPIO_CFG(GPIO_CAM_PWDN, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),	//cam_pwdn
};

static uint32_t camera_on_gpio_table[] = {
	GPIO_CFG(15, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(GPIO_CAM_PWDN, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA),
};
...
struct msm_camera_device_platform_data msm_camera_device_data_rear = {
	.camera_gpio_on  = config_camera_on_gpios_rear,	//static int
	.camera_gpio_off = config_camera_off_gpios_rear, //static void
	...
	.camera_power_on   = camera_power_on_rear,		//static int
	.camera_power_off  = camera_power_off_rear,		//static int
};
...
static struct platform_device *e0trfus_camera_devices[] __initdata = {
#ifdef CONFIG_HI351
...
#endif
	platform_add_devices(e0trfus_camera_devices, ARRAY_SIZE(e0trfus_camera_devices));
