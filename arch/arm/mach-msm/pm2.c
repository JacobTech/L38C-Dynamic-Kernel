...
// LGBSP daewon.seo 2012.07.27 [CM task DOG] [Start] QCT patch - Use a different kernel API to get the sleep length
#include <linux/tick.h>
// LGBSP daewon.seo 2012.07.27 [CM task DOG] [End] QCT patch
...
// LGBSP daewon.seo 2012.07.27 [CM task DOG] [Start] QCT patch - Use a different kernel API to get the sleep length
		...
		low_power = 0;
#endif
// LGBSP daewon.seo 2012.07.27 [CM task DOG] [End]
