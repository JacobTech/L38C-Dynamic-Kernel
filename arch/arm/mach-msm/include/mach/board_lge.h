...
#if defined (CONFIG_MACH_MSM7X27A_TRFUS) /* peter_ported */
...
#if defined(CONFIG_MACH_MSM7X25A_E0EU)|| defined(CONFIG_MACH_MSM7X27A_TRFUS)  // for test E0
/* LCD panel */
enum {
	PANEL_ID_AUTO = 0,
...
//                                                    
/*                                                 */
unsigned lge_get_batt_therm_adc(void);
/*                                                 */
#endif
//                                             
