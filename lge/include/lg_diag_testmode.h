...
} test_mode_req_dload_meid_type;

#define MODEL_NAME_BUF_SIZE	50
typedef enum
{
	TESTMODE_DLOAD_MODEL_NAME_READ = 0,
} test_mode_req_dload_model_name_type;
//                                                                    
...
//                                                                    
	test_mode_req_dload_meid_type dload_meid;
	test_mode_req_dload_model_name_type dload_model_name;
//                                                                    
...
} PACKED DIAG_UTS_RADIO_rsp_type;
