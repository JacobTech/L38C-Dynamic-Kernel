...
static void m3d_keypad_led_store(struct led_classdev *led_cdev,
...
static int __devinit m3d_keypad_led_probe(struct platform_device *pdev)
{
	int ret = 0;
...
static int m3d_keypad_led_remove(struct platform_device *pdev)
{
...
static struct platform_driver m3d_keypad_led_driver = {
	.probe = m3d_keypad_led_probe,
	.remove = m3d_keypad_led_remove,
	.driver = {
		.name = "keypad_led",
		.owner = THIS_MODULE,
	},
...
static int __init m3d_keypad_led_init(void)
{
	return platform_driver_register(&m3d_keypad_led_driver);
}

static void __exit m3d_keypad_led_exit(void)
{
	platform_driver_unregister(&m3d_keypad_led_driver);
}

module_init(m3d_keypad_led_init);
module_exit(m3d_keypad_led_exit);

MODULE_DESCRIPTION("M3D Keypad Lighting driver");
