...
//                                                                                                                   
#ifdef CONFIG_HI351
//	msm_io_w(val, csibase + MIPI_PHY_D1_CONTROL2);	//This line can be open if the model uses 2 cameras
//	msm_io_w(val, csibase + MIPI_PHY_D2_CONTROL2);
//	msm_io_w(val, csibase + MIPI_PHY_D3_CONTROL2);
	msm_io_w(0x00000000, csibase + MIPI_PHY_D1_CONTROL2);	//This line can be open if the model uses 2 cameras
