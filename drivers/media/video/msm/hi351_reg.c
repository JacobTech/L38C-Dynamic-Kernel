...
//            
	...
	{0x8e, 0x80, BYTE_LEN},
	{0x8f, 0x0f, BYTE_LEN},
	{0x90, 0x0f, BYTE_LEN}, //BLC_TIME_TH_ON
	{0x91, 0x0f, BYTE_LEN}, //BLC_TIME_TH_OFF 
	...
	{0xa7, 0x88, BURST_TYPE}, //dark	 MR Low Light Tuning
	...
	{0xd7, 0xe0, BURST_TYPE},//DCDC_AG_TH_OFF  // STEVE AGC 0xf0
...
//            
	...
	{0x03, 0x20, BYTE_LEN},
	{0x12, 0x6d, BYTE_LEN}, //STEVE Dgain ON for Low Light Spec. (2d) MR
	...
	{0x03, 0xd5, BYTE_LEN},
	{0x11, 0xb1, BYTE_LEN}, //manual sleep onoff STEVE Y correnctio OFF 20120220 Dgain Lowlight	
...
//                                            
	...
	///////////////////////////////////////////
	{0x2b, 0x88, BURST_TYPE},//SATB_00 STEVE for Low Light 
	{0x2c, 0x88, BURST_TYPE},//SATB_01 STEVE for Low Light 
	{0x2d, 0x88, BURST_TYPE},//SATB_02 STEVE for Low Light 
	...
	{0x37, 0x88, BURST_TYPE},//SATR_00 STEVE for Low Light 
	{0x38, 0x88, BURST_TYPE},//SATR_01 STEVE for Low Light 
	{0x39, 0x90, BURST_TYPE},//SATR_02 STEVE for Low Light 
...
struct hi351_i2c_reg_conf hi351_snap_settings[] = {
	...
	{0x03, 0xFE, DELAY_TYPE},
	{0xFE, 0x0A, DELAY_TYPE}, //Delay STEVE DV2 MUST WAIT 10msec - change to 8ms in code which measured actual 10 ms delay 
	{0x03, 0x00, BYTE_LEN},
	{0x20, 0x00, BYTE_LEN},
	...
	{0x03, 0xFE, DELAY_TYPE},
	{0xFE, 0x14, DELAY_TYPE}, //Delay 20ms	16 ms delay but actual delay in measurement is 20 ms
...
struct hi351_i2c_reg_conf hi351_scene_normal_settings[] = {
	...
	{0xb9, 0x58, BYTE_LEN}, //STEVE bOutRgainMin_a00_n00
	{0xba, 0xf0, BYTE_LEN}, //bOutRgainMax_a00_n00
	{0xbb, 0x40, BYTE_LEN}, //bOutBgainMin_a00_n00
	{0xbc, 0x90, BYTE_LEN}, //STEVE bOutBgainMax_a00_n00
...
struct hi351_i2c_reg_conf hi351_scene_portrait_settings[] = {
	...
	{0xba, 0xf0, BYTE_LEN}, //bOutRgainMax_a00_n00
	{0xbb, 0x40, BYTE_LEN}, //bOutBgainMin_a00_n00
	{0xbc, 0x90, BYTE_LEN}, //bOutBgainMax_a00_n00
	...
	// STEVE SATB 
	{0x2b, 0x78, BYTE_LEN},//SATB_00"
	{0x2c, 0x78, BYTE_LEN},//SATB_01"
	{0x2d, 0x78, BYTE_LEN},//SATB_02"
	...
	// STEVE SATR 
	{0x37, 0x78, BYTE_LEN},//SATR_00"
	{0x38, 0x78, BYTE_LEN},//SATR_01"
	{0x39, 0x78, BYTE_LEN},//SATR_02"
...
struct hi351_i2c_reg_conf hi351_auto_framerate_settings[] = {
  ...
  {0xae, 0x03, BYTE_LEN}, //14 page
	...
	{0x90, 0x0f, BYTE_LEN}, //BLC_TIME_TH_ON  // STEVE fixed
	{0x91, 0x0f, BYTE_LEN}, //BLC_TIME_TH_OFF // STEVE fixed
	{0x92, 0xe8, BYTE_LEN}, //BLC_AG_TH_ON    //// STEVE fixed AGC 0xD0
	{0x93, 0xe0, BYTE_LEN}, //BLC_AG_TH_OFF   //// STEVE fixed AGC 0xD0
	
	//DCDC 
	{0x03, 0x02, BYTE_LEN}, //PAGE 2
	{0xd4, 0x0f, BYTE_LEN}, //DCDC_TIME_TH_ON
	{0xd5, 0x0f, BYTE_LEN}, //DCDC_TIME_TH_OFF 
	{0xd6, 0xe8, BYTE_LEN}, //DCDC_AG_TH_ON
	{0xd7, 0xe0, BYTE_LEN}, //DCDC_AG_TH_OFF
	
	{0x03, 0xcf, BYTE_LEN}, // STEVE : EV max -> 94 b6 b4 [fixed frame : not enough int. time]
	{0x13, 0x02, BYTE_LEN}, //Y_LUM_MAX 8fps, AG 0xF0   
	{0x14, 0x60, BYTE_LEN}, 
	{0x15, 0x00, BYTE_LEN},                              
	{0x16, 0x00, BYTE_LEN},   
	...
	{0x03, 0xcf, BYTE_LEN}, //Adaptive On						   
	{0x10, 0xaf, BYTE_LEN},  // STEVE all on   
...
// CAMCODER MODE : 30 ~ 22FPS	
	...
	{0x03, 0x00, BYTE_LEN}, //PAGE 0
	{0x90, 0x05, BYTE_LEN}, //BLC_TIME_TH_ON
	{0x91, 0x05, BYTE_LEN}, //BLC_TIME_TH_OFF 
	{0x92, 0xe8, BYTE_LEN}, //BLC_AG_TH_ON  //STEVE AGC OxD0
	{0x93, 0xe0, BYTE_LEN}, //BLC_AG_TH_OFF //STEVE AGC OxD0
	
	//DCDC 
	{0x03, 0x02, BYTE_LEN}, //PAGE 2
	{0xd4, 0x05, BYTE_LEN}, //DCDC_TIME_TH_ON
	{0xd5, 0x05, BYTE_LEN}, //DCDC_TIME_TH_OFF 
	{0xd6, 0xe8, BYTE_LEN}, //DCDC_AG_TH_ON
	{0xd7, 0xe0, BYTE_LEN}, //DCDC_AG_TH_OFF
...
struct hi351_i2c_reg_conf hi351_attached_framerate_settings[] = {
	...
	{0x03, 0x00, BYTE_LEN}, //PAGE 0                              
	{0x90, 0x04, BYTE_LEN}, //BLC_TIME_TH_ON  STEVE fixed           
	{0x91, 0x04, BYTE_LEN}, //BLC_TIME_TH_OFF STEVE fixed           
	{0x92, 0xe8, BYTE_LEN}, //BLC_AG_TH_ON    STEVE fixed AGC 0xD0
	{0x93, 0xe0, BYTE_LEN}, //BLC_AG_TH_OFF   STEVE fixed AGC 0xD0
	
	//DCDC 
	{0x03, 0x02, BYTE_LEN}, //PAGE 2
	{0xd4, 0x04, BYTE_LEN}, //DCDC_TIME_TH_ON
	{0xd5, 0x04, BYTE_LEN}, //DCDC_TIME_TH_OFF 
	{0xd6, 0xe8, BYTE_LEN}, //DCDC_AG_TH_ON
	{0xd7, 0xe0, BYTE_LEN}, //DCDC_AG_TH_OFF
...
struct hi351_i2c_reg_conf hi351_effect_off_settings[] = {
	...
	//Filter OFF
	{0x03, 0x10, BYTE_LEN},
	{0x12, 0x10, BYTE_LEN}, //constant OFF
...
struct hi351_i2c_reg_conf hi351_effect_mono_settings[] = {
	...
	// Mono
	{0x03, 0x10, BYTE_LEN},
	{0x12, 0x13, BYTE_LEN}, //constant ON
	{0x44, 0x80, BYTE_LEN}, //cb_constant
	{0x45, 0x80, BYTE_LEN}, //cr_constant
...
struct hi351_i2c_reg_conf hi351_effect_negative_settings[] = {
	...
	//Negative
	{0x03, 0x10, BYTE_LEN},
	{0x12, 0x18, BYTE_LEN}, //constant OFF
	{0x44, 0x80, BYTE_LEN}, //cb_constant
	{0x45, 0x80, BYTE_LEN}, //cr_constant
...
struct hi351_i2c_reg_conf hi351_effect_aqua_settings[] = {
	...
	{0x03, 0x10, BYTE_LEN},                    
	{0x12, 0x13, BYTE_LEN}, //constant ON       
	{0x44, 0xA3, BYTE_LEN}, //cb_constant      
	{0x45, 0x60, BYTE_LEN}, //cr_constant      
...
struct hi351_i2c_reg_conf hi351_effect_sepia_settings[] = {
	...
	{0x03, 0x10, BYTE_LEN},
	{0x12, 0x13, BYTE_LEN}, //constant ON
	{0x44, 0x60, BYTE_LEN}, //cb_constant
	{0x45, 0xA3, BYTE_LEN}, //cr_constant
...
struct hi351_i2c_reg_conf hi351_wb_auto_settings[] = {
  ...
  //Cb
  {0x2b, 0x88, BYTE_LEN}, //SATB_00 STEVE for Low Light 
  {0x2c, 0x88, BYTE_LEN}, //SATB_01 STEVE for Low Light 
  {0x2d, 0x88, BYTE_LEN}, //SATB_02 STEVE for Low Light 
  {0x2e, 0x98, BYTE_LEN}, //SATB_03  
  {0x2f, 0x98, BYTE_LEN}, //SATB_04  
  {0x30, 0x98, BYTE_LEN}, //SATB_05
  {0x31, 0xa0, BYTE_LEN}, //SATB_06
  {0x32, 0xa0, BYTE_LEN}, //SATB_07
  {0x33, 0xa0, BYTE_LEN}, //SATB_08
  {0x34, 0xa8, BYTE_LEN}, //SATB_09
  {0x35, 0xa8, BYTE_LEN}, //SATB_10
  {0x36, 0xa8, BYTE_LEN}, //SATB_11 
  ...
  {0x37, 0x88, BYTE_LEN},//SATR_00 STEVE for Low Light 
  {0x38, 0x88, BYTE_LEN},//SATR_01 STEVE for Low Light 
  {0x39, 0x90, BYTE_LEN},//SATR_02 STEVE for Low Light 
  {0x3a, 0x98, BYTE_LEN},//SATR_03
  {0x3b, 0x98, BYTE_LEN},//SATR_04
  {0x3c, 0x98, BYTE_LEN},//SATR_05
  {0x3d, 0xa0, BYTE_LEN},//SATR_06
  {0x3e, 0xa0, BYTE_LEN},//SATR_07
  {0x3f, 0xa0, BYTE_LEN},//SATR_08
  {0x40, 0xa8, BYTE_LEN},//SATR_09
  {0x41, 0xa8, BYTE_LEN},//SATR_10
  {0x42, 0xa8, BYTE_LEN},//SATR_11   
...
struct hi351_i2c_reg_conf hi351_wb_incandescent_settings[] = {
	...
	//AWB target RG angle
	{0xaa, 0x00, BYTE_LEN},//aInRgTgtOfs_a00_n00
	{0xab, 0x00, BYTE_LEN},//aInRgTgtOfs_a01_n00
	{0xac, 0x00, BYTE_LEN},//aInRgTgtOfs_a02_n00
	{0xad, 0x00, BYTE_LEN},//aInRgTgtOfs_a03_n00
	{0xae, 0x00, BYTE_LEN},//aInRgTgtOfs_a04_n00
	{0xaf, 0x00, BYTE_LEN},//aInRgTgtOfs_a05_n00
	{0xb0, 0x00, BYTE_LEN},//aInRgTgtOfs_a06_n00
	{0xb1, 0x00, BYTE_LEN},//aInRgTgtOfs_a07_n00
	
	//AWB target BG angle
	{0xb2, 0x00, BYTE_LEN},//aInBgTgtOfs_a00_n00
	{0xb3, 0x00, BYTE_LEN},//aInBgTgtOfs_a01_n00
	{0xb4, 0x00, BYTE_LEN},//aInBgTgtOfs_a02_n00
	{0xb5, 0x00, BYTE_LEN},//aInBgTgtOfs_a03_n00
	{0xb6, 0x00, BYTE_LEN},//aInBgTgtOfs_a04_n00
	{0xb7, 0x00, BYTE_LEN},//aInBgTgtOfs_a05_n00
	{0xb8, 0x00, BYTE_LEN},//aInBgTgtOfs_a06_n00
	{0xb9, 0x00, BYTE_LEN},//aInBgTgtOfs_a07_n00
				     
	{0x03, 0xc6, BYTE_LEN},                                                     
	{0x18, 0x3C, BYTE_LEN},//bInRgainMin_a00_n00                                
	{0x19, 0x59, BYTE_LEN},//bInRgainMax_a00_n00                                				                                                                                      
	{0x1a, 0x88, BYTE_LEN},//bInBgainMin_a00_n00                                
	{0x1b, 0xA0, BYTE_LEN},//bInBgainMax_a00_n00                                
					   
	{0xb9, 0x3C, BYTE_LEN},//bOutRgainMin_a00_n00                               
	{0xba, 0x59, BYTE_LEN},//bOutRgainMax_a00_n00                                                                                                 
	{0xbb, 0x88, BYTE_LEN},//bOutBgainMin_a00_n00                               
	{0xbc, 0xA0, BYTE_LEN},//bOutBgainMax_a00_n00
  ...
  {0x2c, 0x88, BYTE_LEN}, //SATB_01 STEVE for Low Light 
  {0x2d, 0x88, BYTE_LEN}, //SATB_02 STEVE for Low Light 
  {0x2e, 0xd0, BYTE_LEN}, //SATB_03  
  {0x2f, 0xd0, BYTE_LEN}, //SATB_04  
  {0x30, 0xd0, BYTE_LEN}, //SATB_05
  {0x31, 0xd0, BYTE_LEN}, //SATB_06
  {0x32, 0xd0, BYTE_LEN}, //SATB_07
  {0x33, 0xd0, BYTE_LEN}, //SATB_08
  {0x34, 0xd0, BYTE_LEN}, //SATB_09
  {0x35, 0xd0, BYTE_LEN}, //SATB_10
  {0x36, 0xd0, BYTE_LEN}, //SATB_11 
  ...
  {0x38, 0x88, BYTE_LEN},//SATR_01 STEVE for Low Light 
  {0x39, 0x90, BYTE_LEN},//SATR_02 STEVE for Low Light 
  {0x3a, 0xb0, BYTE_LEN},//SATR_03
  {0x3b, 0xb0, BYTE_LEN},//SATR_04
  {0x3c, 0xb0, BYTE_LEN},//SATR_05
  {0x3d, 0xb0, BYTE_LEN},//SATR_06
  {0x3e, 0xb0, BYTE_LEN},//SATR_07
  {0x3f, 0xb0, BYTE_LEN},//SATR_08
  {0x40, 0xb8, BYTE_LEN},//SATR_09
  {0x41, 0xb8, BYTE_LEN},//SATR_10
  {0x42, 0xb8, BYTE_LEN},//SATR_11   
...
struct hi351_i2c_reg_conf hi351_wb_fluorescent_settings[] = {
	...
	{0x03, 0xc6, BYTE_LEN},                                                     
	{0x18, 0x43, BYTE_LEN},//bInRgainMin_a00_n00                                
	{0x19, 0x60, BYTE_LEN},//bInRgainMax_a00_n00                                                                                                                          
	{0x1a, 0x69, BYTE_LEN},//bInBgainMin_a00_n00                                
	{0x1b, 0x90, BYTE_LEN},//bInBgainMax_a00_n00                                
					  
	{0xb9, 0x43, BYTE_LEN},//bOutRgainMin_a00_n00                               
	{0xba, 0x60, BYTE_LEN},//bOutRgainMax_a00_n00                               
	{0xbb, 0x69, BYTE_LEN},//bOutBgainMin_a00_n00                               
	{0xbc, 0x90, BYTE_LEN},//bOutBgainMax_a00_n00  
...
struct hi351_i2c_reg_conf hi351_wb_daylight_settings[] = {
	...
	{0x03, 0xc6, BYTE_LEN},                                                     
	{0x18, 0x4B, BYTE_LEN},//bInRgainMin_a00_n00                                
	{0x19, 0x6A, BYTE_LEN},//bInRgainMax_a00_n00                                 								                                                                          
	{0x1a, 0x5d, BYTE_LEN},//bInBgainMin_a00_n00                                
	{0x1b, 0x78, BYTE_LEN},//bInBgainMax_a00_n00                                
	                                                                             
	{0xb9, 0x4B, BYTE_LEN},//bOutRgainMin_a00_n00                               
	{0xba, 0x6A, BYTE_LEN},//bOutRgainMax_a00_n00                               
	{0xbb, 0x5d, BYTE_LEN},//bOutBgainMin_a00_n00                               
	{0xbc, 0x78, BYTE_LEN},//bOutBgainMax_a00_n00 
...
struct hi351_i2c_reg_conf hi351_wb_cloudy_settings[] = {
	...
	{0x03, 0xc6, BYTE_LEN},                           																									                          
	{0x18, 0x75, BYTE_LEN},//bInRgainMin_a00_n00      																									                          
	{0x19, 0x8F, BYTE_LEN},//bInRgainMax_a00_n00      																									                          								                                                                          
	{0x1a, 0x40, BYTE_LEN},//bInBgainMin_a00_n00      																									                          
	{0x1b, 0x56, BYTE_LEN},//bInBgainMax_a00_n00      																									                          
					                                          																									                                              
	{0xb9, 0x75, BYTE_LEN},//bOutRgainMin_a00_n00     																									                          
	{0xba, 0x8F, BYTE_LEN},//bOutRgainMax_a00_n00     																									                          						                                                                                    
	{0xbb, 0x40, BYTE_LEN},//bOutBgainMin_a00_n00     																									                          
	{0xbc, 0x56, BYTE_LEN},//bOutBgainMax_a00_n00     																									                          
